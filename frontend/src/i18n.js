...
export function LanguageProvider({ children }) {
  const [lang, setLangState] = useState(() => localStorage.getItem("vanguard_lang") || "en");
  const setLang = (l) => {
...
export const copy = {
  en: {
    ...
    admin: {
      ...
      loginSub: "Restricted area — Vanguard administration only.",
      email: "Email address",
      password: "Password",
      login: "Sign In",
  ...
  sq: {
    ...
    admin: {
      loginTitle: "Qendra e Komandës",
      loginSub: "Zonë e kufizuar — vetëm për administratën e Vanguard.",
      email: "Adresa e emailit",
      password: "Fjalëkalimi",
      login: "Hyr",
      loggingIn: "Duke hyrë...",
      loginFailed: "Hyrja dështoi. Kontrolloni të dhënat.",
      back: "Kthehu te faqja",
      badge: "Admin",
      overview: "Përmbledhja e operacioneve",
      hello: "Mirë se u kthyet",
      total: "Lead-e Gjithsej",
      quiz: "Vlerësime Quiz-i",
      contact: "Kërkesa Kontakti",
      unread: "Të palexuara",
      topServices: "Kërkesa sipas shërbimit",
      all: "Të gjitha",
      search: "Kërko emër ose email...",
      unreadOnly: "Vetëm të palexuarat",
      loading: "Duke ngarkuar lead-et...",
      empty: "Asnjë lead nuk përputhet me filtrat.",
      markRead: "Shëno si e lexuar",
